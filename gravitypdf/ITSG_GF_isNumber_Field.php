 ...
 * @since 4.0
 */
class ITSG_GF_isNumber_Field extends Helper_Abstract_Fields {
		...
		<table autosize="1" class="gfield_list">
				...
				<tbody class="head">
					<tr>
						<?php foreach ( $columns as $column ) : ?>
							<th>
								<?php echo strip_tags( $column, '<div><strong>'); ?>
							</th>
						<?php endforeach; ?>
					</tr>
				</tbody>
			...
			<?php foreach ( $value as $item ) : ?>
				<tr>
					...
					<?php if ( ! $columns ) : ?>
						<td><?php echo strip_tags( $item, '<div><strong>') ?></td>
					<?php else : ?><!-- handle the advanced list -->
						<?php foreach ( $columns as $column ) : ?>
							<td>
								<?php echo strip_tags( rgar( $item, $column ), '<div><strong>' ); ?>
							</td>
						<?php endforeach; ?>
					<?php endif; ?>
				</tr>
